...
const items: AnnotationItem[] = [
  ...
  { id: 'c', label: '3', kind: 'text', points: [{ x: 100, y: 50 }], colorLabel: '蓝色', note: '这里需要更醒目', fontSize: 22 },
  { id: 'd', label: '4', kind: 'ruler', points: [{ x: 10, y: 10 }, { x: 110, y: 60 }], colorLabel: '红色' },
];
...
expectEqual(
  ...
  [
    ...
    '3. [text] x=100, y=50 font=22px color=蓝色：这里需要更醒目',
    '4. [ruler] from=(10, 10), to=(110, 60), length=112px, dx=100px, dy=50px color=红色',
  ].join('\n'),
);
