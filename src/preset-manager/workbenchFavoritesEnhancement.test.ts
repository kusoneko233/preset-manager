...
expectIncludes(workbench, 'margin: -2px 35px 6px 13px;');
...
expectIncludes(favoriteFolder, '  gap: 2px;');
...
expectIncludes(favoriteFolder, '.fav-preview {\n  display: -webkit-box;\n  margin: -2px 35px 2px 13px;');
expectNotIncludes(favoriteFolder, 'margin: -2px 35px 6px 13px;');
